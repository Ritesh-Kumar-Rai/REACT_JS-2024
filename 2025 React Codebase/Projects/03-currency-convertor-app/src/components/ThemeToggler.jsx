...
const ThemeToggler = () => {
    ...
    const { isDarkThemed, setIsDarkThemed } = useThemeContext();
    ...
    return (
        <div className='absolute top-5 right-2.5 z-10'>
            <button onClick={toggleTheme}
                class="h-12 w-12 rounded-lg p-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
